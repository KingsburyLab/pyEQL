...
Welcome to `pyEQL` contributor's guide.
...
If you experience bugs or general issues with `pyEQL`, please have a look
...
```
conda create -n pyEQL python=3 six virtualenv pytest pytest-cov
conda activate pyEQL
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pyEQL.git
   cd pyEQL
   ```
...
5. Install [pre-commit]:
   ...
   `pyEQL` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pyEQL
[issue tracker]: https://github.com/<USERNAME>/pyEQL/issues
