...
@pytest.fixture
def s3():
    return Solution([["Na+", "4 mol/kg"], ["Cl-", "4 mol/kg"]], volume="2 L", engine="pyeql")


@pytest.fixture
def s5():
    # 100 mg/L as CaCO3 ~ 1 mM
    return Solution([["Ca+2", "40.078 mg/L"], ["CO3-2", "60.0089 mg/L"]], volume="1 L", engine="pyeql")
...
def s5_pH():
    # 100 mg/L as CaCO3 ~ 1 mM
    return Solution(
        [["Ca+2", "40.078 mg/L"], ["CO3-2", "60.0089 mg/L"]], volume="1 L", balance_charge="pH", engine="pyeql"
    )
...
def test_empty_solution_3():
    ...
    s1 = Solution(database=None, engine="pyeql")
...
def test_equilibrate(s1, s2, s5_pH, s6_Ca, caplog):
    ...
    s_zr = Solution(
        {"Zr+4": "0.05 mol/kg", "Na+": "0.05 mol/kg", "Cl-": "0.1 mol/kg"}, engine="pyeql", log_level="WARNING"
    )
...
def test_equilibrate_water_pH7():
    solution = Solution({}, pH=7.00, temperature="25 degC", volume="1 L", engine="pyeql")
...
def test_equilibrate_CO2_with_calcite():
    solution = Solution({}, pH=7.0, volume="1 L", engine="pyeql")
...
def test_equilibrate_FeO3H3_ppt():
    ...
    solution = Solution({"Fe+3": "0.01 mol/L", "OH-": "10**-7 mol/L"}, volume="1 L", engine="pyeql")
    solution.equilibrate()
...
def test_equilibrate_nophaseeq():
    ...
    solution0 = Solution({"CO2(aq)": "0.001 mol/L"}, pH=3.0, volume="1 L", engine="pyeql")
    solution0.equilibrate()
    solution1 = Solution({"CO2(aq)": "0.001 mol/L"}, pH=3.0, volume="1 L", engine="pyeql")
...
def test_equilibrate_logC_pH_carbonate_8_3():
    solution = Solution({"CO2(aq)": "0.001 mol/L"}, pH=8.3, volume="1 L", engine="pyeql")
    solution.equilibrate()
...
def test_equilibrate_logC_pH_carbonate_13():
    solution = Solution({"CO2(aq)": "0.001 mol/L"}, pH=13.0, volume="1 L", engine="pyeql")
    solution.equilibrate()
...
def test_alkalinity():
    solution = Solution({"CO2(aq)": "0.001 mol/L"}, pH=7, volume="1 L", engine="pyeql")
    solution.equilibrate()
...
def test_equilibrate_2L():
    solution = Solution({"Cu+2": "1 umol/L", "O-2": "1 umol/L"}, volume="2 L", engine="pyeql")
...
def test_equilibrate_unrecognized_component():
    solution = Solution({}, engine="pyeql")
...
def test_equilibrate_OER_region():
    ...
    solution = Solution({}, pH=12.0, pE=13, volume="1 L", engine="pyeql")
...
def test_equilibrate_gas_units():
    ...
    s0 = Solution({}, pH=7.0, volume="1 L", engine="pyeql")
    s0.equilibrate(atmosphere=True, gases={"CO2": "0.00031622776601683794 atm"})
    s1 = Solution({}, pH=7.0, volume="1 L", engine="pyeql")
